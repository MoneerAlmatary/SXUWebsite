...
namespace SXUWebsite.Controllers
{
    public class ContactUsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Subject,Message,Email")] ContactUs contactUs)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Subject,Message,Email")] ContactUs contactUs)
        {
            if (id != contactUs.ID)
            {
                return NotFound();
